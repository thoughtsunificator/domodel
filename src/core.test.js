...
ava("eventListener", (test) => {
	...
	test.is(observable._listeners.get("myEvent").length, 1)
	test.is(observable._listeners.get("myEvent")[0].callback.prototype, binding.eventListener.myEvent.prototype)
	test.is(observable._listeners.get("myEvent2").length, 1)
	test.is(observable._listeners.get("myEvent2")[0].callback.prototype, binding.eventListener.myEvent2.prototype)
	test.is(observable._listeners.get("myEvent3").length, 1)
	test.is(observable._listeners.get("myEvent3")[0].callback.prototype, binding.eventListener.myEvent3.prototype)
	test.is(binding.listeners.length, 3)
	test.is(observable._listeners.size, 3)
